...
const RecommendVideo = ({
  ...
  const getName = () => {
    const maxLength = isStudio ? 45 : isOpen ? 15 : 60;
    ...
    <div className={containerClasses}>
      ...
      <div className={contentClasses}>
        ...
        <div>
          ...
          <div className="flex md:block font-medium text-xs items-center">
            <h3 className="text-[#909090]  md:text-sm mt-1 md:mt-0 flex items-center">
              {channel}
            ...
            <h3 className="text-[#909090] mt-1 md:mt-0 flex items-center">
              {views} Views
              <span className="p-1 md:hidden block"> • </span>
            </h3>
            <h3 className="text-[#909090]  mt-1 md:mt-0 flex items-center">
